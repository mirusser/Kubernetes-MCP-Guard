...
| `INFRA_GATE_PLANNER_OBSERVER_BASE_URL` | `InfraGate.Planner` | No | Unset | `http://observer:3003` | Base URL of the Observer HTTP endpoint used for A2A progress updates and tool requests. | Required for the autonomous bidirectional loop. Keep the route service-local and authenticated. |
