...
- Shape the generic approval lifecycle described in [mutation-approval-profile.md](mutation-approval-profile.md): plan envelope, opaque plan identifier, intent and review digests, approval challenges, audit spine, plan validity, challenge TTL, and pre-execution gates.
...
- A glossary in [CONTEXT.md](../CONTEXT.md), a profile sketch in [mutation-approval-profile.md](mutation-approval-profile.md), and initial ADRs for the new generic-core/domain-adapter boundary.
