...
Approval persistence and behavior are tested across multiple test projects:

- `dotnet test tests/InfraGate.Approvals.Postgres.Tests/InfraGate.Approvals.Postgres.Tests.csproj` — PostgreSQL integration tests (Testcontainers) covering plan creation, challenge lifecycle, execution claims, and outcomes.
