...
public static class KubernetesPolicyValidator
{
    ...
    public static KubernetesPolicyResult Validate(
        IReadOnlyList<IKubernetesObject<V1ObjectMeta>> objects,
        KubernetesPolicyOptions options)
    {
        var findings = new List<KubernetesPolicyFinding>();
        ...
        return new KubernetesPolicyResult(findings);
    }

    public static KubernetesPolicyResult ValidateSetDeploymentImage(
    ...
    private static void ValidateDeployment(
        ...
        KubernetesPolicyOptions options,
        List<KubernetesPolicyFinding> findings)
    {
    ...
    private static KubernetesPolicyFinding Deny(string code, string objRef, string message) =>
        new(KubernetesPolicySeverity.Deny, code, objRef, message);

    private static KubernetesPolicyFinding Warn(string code, string objRef, string message) =>
        new(KubernetesPolicySeverity.Warning, code, objRef, message);
}
