...
- `K8sManager.*.cs` contains the behavior behind those tools: status reads, bounded observability and diagnostics reads, request-plan creation, approval elicitation, plan application, rollout waits, and validation helpers.
