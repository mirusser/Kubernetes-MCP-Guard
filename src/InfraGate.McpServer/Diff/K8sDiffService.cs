...
internal static class K8sDiffService
{
    ...
    public static async Task<K8sPlanDiff[]> BuildDiffsAsync(
        ...
        IReadOnlyList<K8sPlanDryRunObject> dryRunObjects,
        CancellationToken cancellationToken)
    {
        var diffs = new List<K8sPlanDiff>();
    ...
    public static K8sPlanDiff BuildDiff(K8sObjectRef obj, string? liveJson, string? proposedJson)
    {
        var normalizedLiveJson = liveJson is null ? null : K8sObjectNormalizer.NormalizeJson(liveJson);
        var normalizedProposedJson = proposedJson is null ? null : K8sObjectNormalizer.NormalizeJson(proposedJson);
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            (K8sConventions.K8sResources.AppsV1, K8sConventions.K8sResources.Deployment) =>
                ReadDeploymentAsync(client, obj, cancellationToken),
            (K8sConventions.K8sResources.V1, K8sConventions.K8sResources.Service) =>
                ReadServiceAsync(client, obj, cancellationToken),
            (K8sConventions.K8sResources.V1, K8sConventions.K8sResources.ConfigMap) =>
    ...
    private static string Summary(K8sObjectRef obj, string changeType)
    {
    ...
    private static string[] YamlLines(string? json)
    {
        ...
        var yaml = K8sObjectNormalizer.ToYaml(json);
