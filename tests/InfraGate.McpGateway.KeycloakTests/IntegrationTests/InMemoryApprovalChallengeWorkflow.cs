...
/// Keycloak integration tests in place of the removed file-backed ApprovalChallengeStore.
/// </summary>
internal sealed class InMemoryApprovalChallengeWorkflow : IApprovalChallengeWorkflow, IApprovalExecutionWorkflow
{
