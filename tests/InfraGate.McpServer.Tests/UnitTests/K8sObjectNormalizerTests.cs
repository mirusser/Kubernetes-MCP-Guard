...
public sealed class K8sObjectNormalizerTests
{
    [Fact]
    public void NormalizeJson_RemovesStatusField()
    {
        ...
        var result = K8sObjectNormalizer.NormalizeJson(json);
    ...
    {
        var result = K8sObjectNormalizer.NormalizeJson("{}");
    ...
    public void ToYaml_ProducesKeyValuePairsFromNormalizedJson()
    {
        ...
        var normalized = K8sObjectNormalizer.NormalizeJson(json);
        var yaml = K8sObjectNormalizer.ToYaml(normalized);
