...
public sealed class KubernetesToolsTests
{
    ...
    public async Task GetAllowedNamespaces_Delegates()
    {
        ...
        var result = await KubernetesTools.GetAllowedNamespaces(manager);
    ...
    public async Task GetK8sStatus_Delegates()
    {
        ...
        var result = await KubernetesTools.GetK8sStatus(manager, DemoNamespace);
    ...
    public async Task GetK8sEvents_Delegates()
    {
        ...
        var result = await KubernetesTools.GetK8sEvents(manager, DemoNamespace);
    ...
    public async Task GetPodLogs_Delegates()
    {
        ...
        var result = await KubernetesTools.GetPodLogs(manager, DemoNamespace, "demo-pod");
    ...
    public async Task GetK8sResource_Delegates()
    {
        ...
        var result = await KubernetesTools.GetK8sResource(manager, DemoNamespace, "Deployment", "demo");
    ...
    public async Task GetDeploymentDiagnostics_Delegates()
    {
        ...
        var result = await KubernetesTools.GetDeploymentDiagnostics(manager, DemoNamespace, "demo");
    ...
    public async Task GetPodDiagnostics_Delegates()
    {
        ...
        var result = await KubernetesTools.GetPodDiagnostics(manager, DemoNamespace, "demo-pod");
    ...
    public async Task GetServiceDiagnostics_Delegates()
    {
        ...
        var result = await KubernetesTools.GetServiceDiagnostics(manager, DemoNamespace, "demo");
    ...
    {
        var method = typeof(KubernetesTools).GetMethod(nameof(KubernetesTools.CheckLiveDrift));

        Assert.NotNull(method);
        Assert.DoesNotContain(method.GetParameters(), parameter => parameter.Name == "planId");
    }

    private static KubernetesManager CreateManager(TestKubernetesApi? api = null)
    {
        ...
        return new KubernetesManager(options, client!, NullLogger<KubernetesManager>.Instance);
    }
